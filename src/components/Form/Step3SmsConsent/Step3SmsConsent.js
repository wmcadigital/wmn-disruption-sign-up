    ...
    <form onSubmit={handleSubmit} ref={formRef} autoComplete="on">
      ...
      <fieldset className="wmnds-fe-fieldset wmnds-col-1 wmnds-col-lg-4-5">
        <legend className="wmnds-fe-fieldset__legend">
          ...
          <h4>Introduction</h4>
          <p>
            These Website Standard Terms and Conditions written on this webpage shall manage your
            use of our website, West Midlands Network accessible at wmnetwork.co.uk.
          </p>
          <p>
            These Terms will be applied fully and affect to your use of this service. By using this
            service, you agree to accept all terms and conditions written in here. You must not use
            this service if you disagree with any of these Website Standard Terms and Conditions.
          </p>
          <h4>Your Privacy</h4>
          ...
          <p>
            Transport for West Midlands (TfWM) is permitted to revise these Terms at any time as it
            sees fit, and by using this service you are expected to review these Terms on a regular
            basis.
          </p>
          <h4>Assignment </h4>
          <p>
            The Transport for West Midlands (TfWM) is allowed to assign, transfer, and subcontract
            its rights and/or obligations under these Terms without any notification. However, you
            are not allowed to assign, transfer, or subcontract any of your rights and/or
            obligations under these Terms.
          </p>
          <h4>Entire Agreement</h4>
          <p>
            These Terms constitute the entire agreement between Transport for West Midlands (TfWM)
            and you in relation to your use of this service, and supersede all prior agreements and
            understandings.
          </p>
        </legend>
